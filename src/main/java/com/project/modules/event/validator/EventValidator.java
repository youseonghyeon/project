package com.project.modules.event.validator;
...
public class EventValidator implements Validator {
    ...
    public boolean validateUpdateForm(Event event, EventForm eventForm, Errors errors) {
        Integer beforeLimit = event.getLimitOfEnrollments();
        Integer afterLimit = eventForm.getLimitOfEnrollments();
